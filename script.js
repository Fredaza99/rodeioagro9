    ...
    try {
        ...
        const interval = setInterval(() => {
            ...
            if (totalEntradasElem && totalSaldoElem) {
                ...
                console.warn('Elementos para entradas e saldo não encontrados, tentando novamente...');
            }
        }, 100); // Tenta a cada 100ms até encontrar os elementos
    } catch (error) {
...
function renderClients(clients) {
    ...
    }, 100); // Tenta a cada 100ms até encontrar o elemento da tabela
}
